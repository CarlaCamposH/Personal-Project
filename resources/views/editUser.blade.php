                ...
                <div class="px-6 py-4">
                    <div class="text-pink-500">
                        <p
                            ...
                            EDIT PROFILE <i class="fa-solid fa-fire"></i></p>
                    </div>
                    <form action="/editUser" method="POST" id="editUser">
                        ...
                        <div>
                            ...
                            <label
                                class="font-bold text-transparent text-2xl bg-clip-text bg-gradient-to-br from-pink-500 to-orange-400">Username</label>
                            ...
                            <button
                                class="mt-2 block text-white bg-gradient-to-r from-orange-400 to-pink-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                type="button" data-modal-toggle="defaultModal">
                                Change ur photo! <i class="fa-solid fa-camera"></i>
                            </button>
                            ...
                            <div>
                                ...
                                <div x-data="{toggle: false}">
                                    ...
                                    <div class="flex  mt-2">
                                        <label
                                            class="font-bold text-transparent text-2xl bg-clip-text bg-gradient-to-br from-pink-500 to-orange-400">
                                            Private or nah? </label>
                                        <div class=" relative w-12 h-6 transition duration-200 ease-linear rounded-full ml-2 mt-1"
                                            :class="[toggle ? 'bg-gradient-to-br from-pink-500 to-orange-400' : 'bg-gray-300']">
                                            <label for="toggle"
                                                class="absolute left-0 w-6 h-6 transition duration-100 ease-linear transform bg-gray-100 rounded-full cursor-pointer"
                                                :class="[toggle ? 'translate-x-full border-gray-400' : 'translate-x-0 border-green-400']">
                                            </label>

                                            <input type="checkbox" id="toggle" name="toggle" x-model="toggle"
                                                class="hidden w-full h-full appearance-none focus:outline-none" />
                                        </div>
                                    </div>
                                </div>
                                @else
                                ...
                                <label
                                class="font-bold text-transparent text-2xl bg-clip-text bg-gradient-to-br from-pink-500 to-orange-400">About u.</label>
                            ...
                            <button onclick="submitA()"
                                ...
                                name="cmd" value="save">Save Changes!</button>
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <h1 id="title2"
                    class="hidden font-bold text-transparent text-2xl bg-clip-text bg-gradient-to-br from-pink-500 to-orange-400">
                ...
                <label id="hideLabel"
                    ...
                    <div class="flex flex-col items-center justify-center pt-7">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-8 h-8 text-pink-500/50 group-hover:text-gray-600" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
            ...
            <div id="resetP" class="hidden flex items-center justify-center pl-3 pb-3">
                <button onclick="resetphoto()" type="button"
                    class="text-white bg-gradient-to-br from-green-400 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Select
                    another Photo <i class="fa-solid fa-arrow-rotate-right"></i></button>
            </div>
            <!-- Modal footer -->
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                <button data-modal-toggle="defaultModal" type="button"
                    class="text-white bg-gradient-to-br from-green-400 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I
                    feel pretty <i class="fa-solid fa-star"></i></button>
                <button data-modal-toggle="defaultModal" type="button"
...
<input type="hidden" id="base64foto" value="{{$user->pfp}}">
...
<script>
    ...
    function submitA() {
        ...
        var private = document.getElementById("toggle");
        var aboutme = document.getElementById("aboutme");

        var data = document.getElementById("data");
        var sendData = [username.value, name.value, imageBase64.value, private.value, aboutme.value];
    ...
    function recortarImagen(data) {
        ...
        miNuevaImagenTemp.onload = function () {
            // Se recorta
            contexto.drawImage(miNuevaImagenTemp, inicioX, inicioY, nuevoAncho * zoom, nuevaAltura * zoom, 0, 0,
                nuevoAncho, nuevaAltura);
